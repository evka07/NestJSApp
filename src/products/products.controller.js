...
var ProductsController = function () {
    ...
    var _getAllExtended_decorators;
    var _getExtendedById_decorators;
    ...
    var ProductsController = _classThis = /** @class */ (function () {
        ...
        ProductsController_1.prototype.getAllExtended = function () {
            return this.productsService.getAllExtended();
        };
        ProductsController_1.prototype.getExtendedById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var prod;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.productsService.getExtendedById(id)];
                        case 1:
                            prod = _a.sent();
                            if (!prod)
        ...
        ProductsController_1.prototype.create = function (productData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.productsService.create(productData)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    (function () {
        ...
        _getAllExtended_decorators = [(0, common_1.Get)('/extend')];
        _getExtendedById_decorators = [(0, common_1.Get)('/extended/:id')];
        _getById_decorators = [(0, common_1.Get)('/:id')];
        _deleteById_decorators = [(0, common_1.Delete)('/:id')];
        ...
        __esDecorate(_classThis, null, _getAllExtended_decorators, { kind: "method", name: "getAllExtended", static: false, private: false, access: { has: function (obj) { return "getAllExtended" in obj; }, get: function (obj) { return obj.getAllExtended; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _getExtendedById_decorators, { kind: "method", name: "getExtendedById", static: false, private: false, access: { has: function (obj) { return "getExtendedById" in obj; }, get: function (obj) { return obj.getExtendedById; } }, metadata: _metadata }, null, _instanceExtraInitializers);
