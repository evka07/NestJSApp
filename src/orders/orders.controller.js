...
var OrdersController = function () {
    ...
    var OrdersController = _classThis = /** @class */ (function () {
        ...
        OrdersController_1.prototype.getAll = function () {
            return this.ordersService.getAll();
        };
        OrdersController_1.prototype.getById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var order;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ordersService.getById(id)];
                        case 1:
                            order = _a.sent();
                            if (!order)
        ...
        OrdersController_1.prototype.deleteById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ordersService.getById(id)];
                        case 1:
                            if (!(_a.sent()))
                                throw new common_1.NotFoundException('Order not found');
                            return [4 /*yield*/, this.ordersService.deleteById(id)];
                        case 2:
                            _a.sent();
        ...
        OrdersController_1.prototype.create = function (orderData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ordersService.create(orderData)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        OrdersController_1.prototype.update = function (id, orderData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ordersService.getById(id)];
                        case 1:
                            if (!(_a.sent()))
                                throw new common_1.NotFoundException('Order not found');
                            return [4 /*yield*/, this.ordersService.updateById(id, orderData)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/, { success: true }];
                    }
